...
*  nperc_24h (the percentage of data available)  
...
plot_data_coverage(hist_dat_combined,type="tad",type2="nperc_24h",na.omit = F,meta=meta, 
...
The current version of `RchivalTag` merges the 6h and 12h histogram data to 24h periods. (Please recall: The column `nperc_24h` indicates the data coverage in percent.)
...
df$nperc_24h <- 100 # necessary to avoid error due to low data availability
